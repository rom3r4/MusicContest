...
MusicContest.create!([
                       ...
                       {contest_status: "finished", topic: "topic9", winner_user_id: 2, start_date: "2019-09-01", end_date: "2019-10-01"},
                       {contest_status: "finished", topic: "topic6", winner_user_id: 2, start_date: "2019-08-01", end_date: "2019-09-01"},
...
Song.create!([
               {spotify_id: "id1", spotify_url: "url1", spotify_title: "title1", spotify_artist: "artist1", spotify_length: 40, spotify_album: "album1", spotify_cover_id: 1, contest_id: 3, submitby_user_id: 1},
               {spotify_id: "id2", spotify_url: "url2", spotify_title: "title2", spotify_artist: "artist2", spotify_length: 40, spotify_album: "album2", spotify_cover_id: 1, contest_id: 3, submitby_user_id: 2}
             ])
